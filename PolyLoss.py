...
#################################################
# file to edit: dev_nb/yiyi_all_about_dice_loss.ipynb
    ...
    def forward(self, input: torch.Tensor, target: torch.Tensor) -> torch.Tensor:
        ...
        Args:
            input: the shape should be BNH[WD], where N is the number of classes.
                You can pass logits or probabilities as input, if pass logit, must set sigmoid=True or softmax=True,
                or specifying other_act.
